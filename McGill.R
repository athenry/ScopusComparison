...
MMcG <- convert2df(DMcG, dbsource = "scopus", format = "bibtex")
...
McGData <- tidy_dataMcG[grep("MCGILL UNIVERSITY", tidy_dataMcG$C1), ]

deptURL <- "https://docs.google.com/spreadsheets/d/e/2PACX-1vSwbFiCTwa2Kd5r62CK04AC7iRfLTDSt18PWe76bO4QSKGqpHkb0I7ZeSesCZN_wGN_NVytVi0x0h1J/pub?gid=296876605&single=true&output=csv"
